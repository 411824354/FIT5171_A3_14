...
<html>
<head>
    <title>Rockets:most launched rocket information</title>

    <meta http-equiv="Content-type" content="text/html;charset=UTF-8">

    <meta name="description" content="Rockets: most launched rocket information - Rockets">
</head>
...
<#else>
    <p>No rocket or not enough rocket yet in the system. <a href="/rocket1/create">Create one</a> now!</p>
</#if>
